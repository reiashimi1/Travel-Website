		...
		<div>
			<form method="post">
				<table border="0" width="400px" height="300px" align="center" class="tableshadow" style="border-color: darkgray;">
					<tr>
						<td class="toptd" style="background-color: dimgray; ">View Subcategory</td>
					</tr>
					<tr>
						<td align="center" valign="top" style="padding-top:10px;">
							<table border="0" align="center" width="70%">
								<tr>
									<td style="font-size:15px; padding:5px; font-weight:bold;">Subcategory Id</td>
									<td style="font-size:15px; padding:5px; font-weight:bold;">Subcategory Name</td>
								</tr>
