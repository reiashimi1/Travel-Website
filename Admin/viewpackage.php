...
<body>
	...
	<div style="padding-top:100px; box-shadow:1px 1px 20px black; min-height:100vh; margin-bottom:10px" class="container">
		<div style="border-right:1px solid #999; min-height:450px;">
			<?php include('left.php'); ?>
		</div>
		<div>
			<form method="post">
				<table border="0" width="90%" height="300px" align="center" class="tableshadow" style="border-color: darkgray;">
					<tr>
						<td class="toptd" style="background-color: dimgray; ">View Package</td>
					</tr>
					<tr>
